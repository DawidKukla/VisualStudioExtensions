...
namespace CmderExtension
{
    ...
    public class Options : DialogPage
    {
        ...
        [Description(
             "Cmder will open in this folder in case it cannot guess the working directory from the current Solution Explorer selection. This is passed to the /start command line option."
         )]
        ...
        [Description(
             "Parameters other than /start to pass to Cmder when launching it. Switches provided here take priority over the ones from other options."
         )]
        ...
        [Description(
             "Activate an already running Cmder instance passing it a task to execute. The same as the /single command line option."
         )]
